# Rock, Paper, Scissors Update 1.1.24 lesson 14 with modules
...
# New addition lesson14 1.1.24 - modules
# This new variable 'Rock_paper_scissors' is created to call for the function
